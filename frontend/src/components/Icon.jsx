...
const PATHS = {
  ...
  // ── Service icons (used as graceful fallback when a service photo is missing) ──
  droplet: (
    <path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z" />
  ),
  droplets: (
    <>
      <path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 5.21 7 4c-.29 1.21-1.14 2.16-2.29 3.06S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z" />
      <path d="M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97" />
    </>
  ),
  sparkles: (
    <>
      <path d="M9.94 14.06A2 2 0 0 0 8.5 12.62l-5.13-1.32a.5.5 0 0 1 0-.96L8.5 9.02a2 2 0 0 0 1.44-1.44l1.32-5.13a.5.5 0 0 1 .96 0l1.32 5.13a2 2 0 0 0 1.44 1.44l5.13 1.32a.5.5 0 0 1 0 .96l-5.13 1.32a2 2 0 0 0-1.44 1.44l-1.32 5.13a.5.5 0 0 1-.96 0z" />
  ...
  spray: (
    <>
      ...
      <path d="M6 16v-2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2z" />
    </>
  ),
  shield: (
